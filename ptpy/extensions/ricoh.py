'''This module extends PTP for Ricoh Theta devices.
...
class Ricoh(object):
    '''This class implements Ricoh's PTP operations.'''

    def __init__(self, *args, **kwargs):
        logger.debug('Init Ricoh')
        super(Ricoh, self).__init__(*args, **kwargs)

    def _PropertyCode(self, **product_properties):
        return super(Ricoh, self)._PropertyCode(
    ...
    def _OperationCode(self, **product_operations):
        return super(Ricoh, self)._OperationCode(
    ...
    def _ResponseCode(self, **product_responses):
        return super(Ricoh, self)._ResponseCode(
    ...
    def _EventCode(self, **product_events):
        return super(Ricoh, self)._EventCode(
    ...
    def _FilesystemType(self, **product_filesystem_types):
        return super(Ricoh, self)._FilesystemType(
    ...
    def _ObjectFormatCode(self, **product_object_formats):
        ...
        return super(Ricoh, self)._ObjectFormatCode(
            MediaCard=0xb211,
